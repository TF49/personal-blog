            ...
            <div className="col-span-full">
              <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-10">
                <p className="text-white/70 text-sm tracking-wider">
                  {error ? 'GitHub 数据加载失败。' : '正在从 GitHub 加载精选仓库…'}
                </p>
                {error ? (
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-8 inline-flex items-center text-[10px] font-bold uppercase tracking-[0.4em] text-white hover:text-[var(--color-primary)] transition-all group py-4 px-8 border border-white/10 hover:border-[var(--color-primary)]"
                >
                  查看 GitHub 仓库 <ArrowRight className="ml-4 w-4 h-4 transition-transform group-hover:translate-x-2" />
                </a>
              </div>
